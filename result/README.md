...
- `layer_scores/`: BMQ, EBS-fusion, and EAAS layer-score files used for layer ranking and diagnostics.
- `figures/`: PNG versions of paper-related generated figures.
- `reports/`: selected quantization reports for BMQ, RTN, GPTQ, and AWQ settings.
...
- `tables/signal_ablation_summary.csv`: EAQ-Test results for FP16, RTN, EAAS-only, EBS-fusion, and BMQ policies.
...
- `layer_scores/behavior_drop_layer_scores.csv`: layer-wise BMQ scores.
